...
export function createEmptyBridgerState() {
  return { bridges: {} };
}
...
export function cycleBridgerBetween(level, state, leftId, rightId) {
...
export function getConnectableBridgePairs(level, state = createEmptyBridgerState()) {
  const pairs = [];
...
export function getVisibleBridgePairs(level, state = createEmptyBridgerState()) {
...
export function getIslandBridgeCounts(level, state = createEmptyBridgerState()) {
...
export function isBridgerSolved(level, state) {
  const islands = level?.islands ?? [];
