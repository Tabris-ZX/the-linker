import { isEditorEdgeInBounds, validateEditorLevelAnswer } from "./editor-checker.js";
import { checkLevelGoodRequest, generateLevelRequest } from "./router.js";
import { hydrateLevel, loadLevelAnswers, saveLevelFile } from "./services.js";
import { edgeKey, fromRenderPoint, getEquilateralTriangleSize, getGridBounds, getGridNodes, isAdjacent, keyOf, lineAttrs, normalizeGridType, pointFromKey, pointsFromEdgeKey, toRenderPoint } from "./utils.js";
import { clampNumber, omitKey } from "./utils.js";
...
export const editorMethods = {
    ...
    syncEditorBounds() {
      ...
      this.editorState.width = clampNumber(this.editorState.width, 2, 19);
      this.editorState.height = clampNumber(this.editorState.height, 2, 15);
      if (this.editorState.gridType === "equilateral-triangle") {
        this.editorState.height = clampNumber(this.editorState.height, 2, 8);
