...
from server.games.linker.services import normalize_level_difficulty
from server.utils.http import http_error

GENERATOR_CONFIG_PATH = PROJECT_ROOT / "config" / "settings" / "generator.json"
GENERATOR_SCRIPT_PATH = PROJECT_ROOT / "server" / "games" / "linker" / "scripts" / "generate-alpha-levels.mjs"
