...
})({"args":["navigator.getBattery","noopPromiseResolve"],"engine":"extension","name":"set-constant","verbose":false,"domainName":"https://www.playlinkr.net/","version":"5.4.3.1"}, ["navigator.getBattery","noopPromiseResolve"]);
...
})({"args":[],"engine":"extension","name":"no-topics","verbose":false,"domainName":"https://www.playlinkr.net/","version":"5.4.3.1"}, []);
(function scriptlets_setConstant(source, args) {
  var flag = "done";
  var uniqueIdentifier = source.uniqueId + source.name + "_" + (Array.isArray(args) ? args.join("_") : "");
  if (source.uniqueId) {
...
})({"args":["navigator.privateAttribution","undefined"],"engine":"extension","name":"set-constant","verbose":false,"domainName":"https://www.playlinkr.net/","version":"5.4.3.1"}, ["navigator.privateAttribution","undefined"]);
...
})({"args":[],"engine":"extension","name":"no-protected-audience","verbose":false,"domainName":"https://www.playlinkr.net/","version":"5.4.3.1"}, []);
